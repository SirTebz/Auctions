...
namespace Auctions.Controllers
{
    public class ListingsController : Controller
    {
        ...
        public ListingsController(IListingsService listingService, IWebHostEnvironment webHostEnvironment, IBidsService bidsService, ICommentsService commentsService)
        {
